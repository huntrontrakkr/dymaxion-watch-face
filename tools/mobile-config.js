...
for(const [key,title] of [['moonIndicator','Moon in top bar'],['batteryGauge','Battery gauge'],['stepLine','Step line'],['dayNight','Day and night'],['lights','City lights'],['sun','Sun on the map'],['edges','Triangle edges']]){
