...
writeFileSync('watchface/src/c/generated/status_glyphs.h',
  ...
  +`#define HERE_SIZE ${HERE_SIZE}\nstatic const uint32_t HERE_GLYPH[HERE_SIZE] = ${pixelRows(HERE_ROWS)};\nstatic const uint32_t HERE_HALO[HERE_SIZE+2] = ${pixelRows(HERE_HALO_ROWS)};\n`
