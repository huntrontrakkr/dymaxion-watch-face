...
import {backgroundMask,netRows,BACKGROUND_BITS,MAP_BACKGROUNDS} from '../shared/map-background.js';
...
}
{
  ...
  for(const pattern of MAP_BACKGROUNDS.slice(1)){
    const grid=backgroundMask(m,pattern,rows);
