...
try{
  ...
  await sheet('gallery-64.png',entries,8,'Dymaxion / 64 ways to see the world','21 palettes · 8 clock styles · 6 panels · Meridian & Horizon · sample data');
  ...
  await sheet('new-palettes.png',entries.filter(e=>e.themeId>=14&&e.variant===0),4,'Seven new perspectives','Red Atlantic · cool daylight / warm nights · color and shape at watch resolution');
