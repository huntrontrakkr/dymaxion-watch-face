...
// Codes 5-8 are Pebble system fonts, 9 is Leco Delta (shared/system-clock.js).
export const DISPLAY_STYLES=['span','triangles','broad','chamfer','leco','bitham-bold','bitham-light','bitham-medium','leco-delta'];
// Wire codes. 3 was the retired LCD style, which the watch migrates to broad.
export const DISPLAY_CODES=Object.freeze({span:0,triangles:1,broad:2,chamfer:4,leco:5,'bitham-bold':6,'bitham-light':7,'bitham-medium':8,'leco-delta':9});
