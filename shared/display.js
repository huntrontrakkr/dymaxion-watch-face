...
// lets map times turn 90°; bit 0 is retired. Byte 3
...
export function encodeDisplay(settings){
  ...
  return new Uint8Array([2,style,(settings.leadingZero===false?2:0)|zones<<2|position<<4|(settings.mapTimesTurn?64:0),background]);
}
