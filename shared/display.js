...
// night end, 0]. Byte 2: bit 1 no leading zero (clear by default), bits 2-3
...
export function encodeDisplay(settings){
  ...
  return new Uint8Array([3,style,(settings.leadingZero===false?2:0)|zones<<2|position<<4|(settings.mapTimesTurn?64:0)|(settings.nameplate?128:0),background,...encodePower(settings.power),0]);
}
