...
export function encodeFooter(s){
  ...
  v.setUint16(43,Math.round(w.rainMax*10),true);b[45]=+(t.scale==='fixed');v.setInt16(46,Math.round(t.min*100),true);v.setInt16(48,Math.round(t.max*100),true);b[50]=w.place;b[51]=+w.humidityLine;b[52]=+w.tideMarks;
  return b;
}
