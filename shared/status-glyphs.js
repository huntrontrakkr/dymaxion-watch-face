...
// The subsolar point: a small sun, an orb with eight short rays, on its own
// clearing so it reads over land, ocean and the terminator.
export const SUN_SIZE=7;
export const SUN_ROWS=['...#...','.#...#.','..###..','#.###.#','..###..','.#...#.','...#...'];
export const SUN_HALO_ROWS=['..#####..','.#######.','#########','#########','#########','#########','#########','.#######.','..#####..'];
