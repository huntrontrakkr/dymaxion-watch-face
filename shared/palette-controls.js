...
export function paletteControls(root,getSettings,onChange){
  ...
  function refresh(){
    ...
    root.querySelector('[data-summary]').textContent=custom?'Saved with your settings. Export them to back up or share your palettes.':`Based on ${p.name}. Change any color below. Your saved palettes stay in the list when you switch to a preset.`;
