...
// Three sizes of one square-cornered figure design, chosen in the settings
// (Map time size): 3×5, 3×6 (the default) and 3×7, each a row taller than the
// last. They share widths, so a label's template fits any.
