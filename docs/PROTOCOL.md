...
Bitham 42 Bold, Bitham 42 Light, Bitham 42 Medium Numbers), drawn from firmware,
and 9 Leco Delta (Leco 42 with 60-degree corners), drawn from bundled bitmaps. Byte 2 bit 0 shows unlit triangles in
