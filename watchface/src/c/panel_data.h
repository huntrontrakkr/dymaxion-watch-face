...
enum { F_ENABLED=1,F_COUNT=2,F_HOME=3,F_ORDER=4,F_ROTATE=9,F_HORIZON=10,F_FAHRENHEIT=11,F_RAIN=12,F_DAYLIGHT=13,F_GRID=14,F_SOLAR=15,F_WEEK_START=16,F_PREVIOUS=17,F_WEEKENDS=18,F_HOLIDAYS=19,F_TODAY_OUTLINE=20,F_TEMP_COLOR=21,F_RAIN_COLOR=22,F_HUMID_COLOR=23,F_TIDE_COLOR=24,F_SAT_COLOR=25,F_SUN_COLOR=26,F_HOLIDAY_COLOR=27,F_TODAY_COLOR=28,F_TEMP_FIXED=29,F_HUMID_AUTO=30,F_TEMP_MIN=31,F_TEMP_MAX=33,F_RAIN_INCH=35,F_TIDE_FEET=36,F_REFRESH=37,F_WEATHER_ON=38,F_RANGE_LABELS=39,F_TIDE_ZERO=40,F_TIDE_ON=41,F_SHAKE=42,F_WEATHER_PLACE=50,F_HUMID_LINE=51,F_TIDE_MARKS=52 };
...
// High and low tides from hourly predictions (tideExtremes in shared/panel-data.js).
int tide_extremes(const uint8_t *tide,uint32_t *times,bool *high,int max);
